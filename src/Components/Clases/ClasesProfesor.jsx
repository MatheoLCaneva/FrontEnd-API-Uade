                ...
                response => response.json().then(response => {
                    if (response.status === 201) {
                        ...
                        const obj = {
                            ...
                            mensaje: `La clase ${response.data._id} ha sido creada con éxito. </br> Puede ver su nueva clase aquí: http://localhost:4000/clase/${response.data._id}`,
            ...
            .then(data => {
                if (data.status === 200) {
                    ...
                    const obj = {
                        tipo: 0,
                        email: user.email,
                        asunto: 'Clase Modificada',
                        name: user.name,
                        apellido: user.apellido,
                        mensaje: `La clase ${nuevaClase._id} ha sido actualizada con éxito. </br> Puede ver sus cambios aquí: http://localhost:4000/clase/${nuevaClase._id}`,
                        ...
                        .then(data => {
                            if (data.status === 200) {
                                ...
                                Swal.fire({
                                    ...
                                    text: 'Su clase se actualizo con éxito',
                                    icon: 'success',
                                })
                                    .then(res => {
                                        if (res.isConfirmed) {
                        ...
                        <TableBody>
                            {ClasesProfesor.map(row => (
                                <TableRow key={row._id}>
                                    ...
                                    <TableCell align="right">{row.duracion}hs</TableCell>
